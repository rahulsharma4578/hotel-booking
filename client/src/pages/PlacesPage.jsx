...
export default function PlacesPage() {
    ...
    async function addPhotoByLink(ev) {
        ...
        setAddedPhotos(prev => {
            return [...prev, filename]; // Here it is returning array along with the previous values.
        });
        setPhotoLink('');
    }
                ...
                <div>
                    <form >
                        ...
                        <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                            ...
                            <button className="flex items-center gap-3 justify-center border bg-transparent rounded-2xl p-2 text-2xl text-gray-600">
